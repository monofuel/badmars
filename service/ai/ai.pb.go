...
func init() {
	proto.RegisterType((*Entity)(nil), "ai.Entity")
	proto.RegisterType((*Success)(nil), "ai.Success")
}
...
func (c *aIClient) ProcessUnit(ctx context.Context, in *Entity, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := grpc.Invoke(ctx, "/ai.AI/processUnit", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	,
}
