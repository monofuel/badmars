...
#this code is starting to look ugly
grid2_mesh = new THREE.Mesh(grid_geom,landMaterial)
water2_mesh = new THREE.Mesh(water_geom,waterMaterial)
scene.add(grid2_mesh)
scene.add(water2_mesh)
...
grid_mesh.position.y = -5
grid_mesh.position.z = 16
grid_mesh.rotation.x = - Math.PI / 2
water_mesh.position.y = -5
water_mesh.position.z = 16
water_mesh.rotation.x = - Math.PI / 2

#reaaaaall ugly
grid2_mesh.position.y = -5
grid2_mesh.position.z = 47
grid2_mesh.rotation.x = - Math.PI / 2
water2_mesh.position.y = -5
water2_mesh.position.z = 47
water2_mesh.rotation.x = - Math.PI / 2
